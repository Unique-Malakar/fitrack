...
PROFILE = {
    ...
    # AI-credit tracker series. End values track the real readings pulled from FRED.
    "NCBDBIQ027S":   (8982885.0, 760000.0, 21000.0),
    "DRCRELEXFACBS": (1.5, 0.42, 0.05, 2.0),
    "DRBLACBS":      (1.3, 0.22, 0.04, 1.8),
    "IRLTLT01JPM156N": (2.7, 1.35, 0.06, 1.6),
    "BOGZ1FL543063005Q": (3927944.0, 290000.0, 14000.0),
    "BOGZ1FL544090005Q": (10974928.0, 720000.0, 32000.0),
    "DGS2":          (3.62, -0.35, 0.06),
...
AV_PROFILE = {
    ...
    "QQQ":  (612.40, 4.1, 0.78, 2.6),
    "IWM":  (241.80, -1.9, 0.85, 2.2),
    "TLT":  (86.30, -3.2, 0.60, 2.4),
    "EFA":  (94.70, 3.3, 0.55, 2.0),
    "EEM":  (52.10, 1.8, 0.70, 2.0),
